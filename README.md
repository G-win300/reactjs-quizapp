# Kubernetes DevSecOps CICD Project Using azure devops and ArgoCD
...
3. Github Actions Configuration: configure essential githubt actions on Github Actions workflow, including Snyk, Docker, Sonarqube, Terraform, Kubectl, AKS CLI, and Trivy.
4. AKS Cluster Deployment: Utilize eksctl commands to create an azure AKS cluster, a managed Kubernetes service on AWS.
...
11. Github Action Pipelines: Create Github Action pipelines for deploying backend and frontend code to the AKS cluster.
...
- An Azure devops account with the necessary permissions to create resources.
- Terraform and AWS CLI installed on your local computer.
- Basic familiarity with Kubernetes, Docker, CICD pipelines, azure devops Github Actions, Terraform, and DevOps principles.
